...
function cargarProductos() {
    ...
    //guardamos productos
    //localStorage.getItem('productos', producto) -[object - object]
    //1. creamos una variable para que podamos comvertir los datos a json
    let misProductos =JSON.stringify(productos);
    //2. le pasamos la variable a local storage
