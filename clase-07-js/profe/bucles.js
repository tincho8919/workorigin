...
for (let i = 0; i < persona.length; i++) {
    ...
    console.log('   los eementos de persona son:               ' + persona[i]);
}
console.log('============================================================================');
console.log('============================================================================');

//intruducir en un array
let alumnos = [];
let data = prompt('intruduce un/a alumno/a: ' );

//funcion para guardar datos en un arreglo -push
...
alumnos.push(data) 
{
    if (!data) {
        ...
        alumnos.push(data)
        alert(`ingrese el alumno ${data} el arreglo de alumnos`)
    }
}  
console.log(alumnos);